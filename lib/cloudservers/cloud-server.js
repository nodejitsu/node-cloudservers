...
var serverAction = function(id, body, client, callback) {
  var actionOptions = {
    method: 'POST',
    client: client,
    uri: client.serverUrl('servers', id, 'action'),
    body: body
  };
...
CloudServer.prototype = {
  ...
  destroy: function (callback) {
    this.client.destoryServer(this.id, callback);
  },
  ...
  disableBackup: function (callback) {
    var disableUrl = this.client.serverUrl('servers', this.id, 'backup_schedule');
  ...
  getAddresses: function () {
    ...
    var self = this;
    utils.rackspace(this.client.serverUrl('servers', this.id, 'ips', type), this.client, callback, function (body) {
  ...
  getBackup: function (callback) {
    var backupOptions = {
      method: 'GET', 
      uri: this.client.serverUrl('servers', this.id, 'backup_schedule'),
      client: this.client
    };
  ...
  update: function (name, pass, callback) {
    var updateOptions = {
      method: 'PUT',
      uri: this.client.serverUrl('servers', this.id),
      client: this.client,
      body: {
        'server': {
          'name': name,
