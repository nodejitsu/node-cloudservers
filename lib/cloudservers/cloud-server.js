...
//
var serverAction = function(id, body, callback) {
  var actionOptions = {
    method: 'POST',
    uri: utils.serverUrl('servers', id, 'action'),
    body: body
  };
...
CloudServer.prototype = {
  ...
  confirmResize: function (callback) {
    serverAction(this.id, { 'confirmResize': null }, callback);
  },
  ...
  disableBackup: function (callback) {
    utils.rackspaceCurl('DELETE', utils.serverUrl('servers', this.id, 'backup_schedule'), callback, function (body, res) {
      callback(null, res);
    });
  },
  ...
  reboot: function () {
    ...
    serverAction(this.id, { 'reboot': { 'type': type.toUpperCase() } }, callback);
  },
  ...
  rebuild: function (image, callback) {
    ...
    serverAction(this.id, { 'rebuild': { 'imageId': imageId } }, callback);
  },
  ...
  resize: function (flavor, callback) {
    ...
    serverAction(this.id, { 'resize': { 'flavorId': flavorId } }, callback);
  },
  ...
  revertResize: function (callback) {
    serverAction(this.id, { 'revertResize': null }, callback);
  },
