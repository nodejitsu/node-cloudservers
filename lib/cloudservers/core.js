...
Client.prototype.setAuth = function (callback) {
  var self = this;
  var authUrl = this.config.auth.host || authUrl;
  var authOptions = {
...
Client.prototype.renameServer = function (server, name, callback) {
  ...
  utils.rackspace({method:'PUT', uri: this.serverUrl('servers', serverId), body: {server:{name:name}}, client: this}, callback, function (body, response) {
...
Client.prototype.destroyImage = function (image, callback) {
  ...
  var destroyOptions = {
    method: 'DELETE',
    uri: this.serverUrl('images', imageId),
    client: self
  };
