...
//   4. utils.rackspace({ method: 'POST', uri: 'some-url', body: { some: 'body'} }, client, callback, success)
//
utils.rackspace = function () {
  var args = Array.prototype.slice.call(arguments),
      success = (typeof(args[args.length - 1]) === 'function') && args.pop(),
      callback = (typeof(args[args.length - 1]) === 'function') && args.pop(),
      uri, method, requestBody, client;
...
utils.rackspaceCurl = function (method, uri, callback, success) {
  var options = 'curl ', error = '', data = '', client = options['client'];;
